...
contract FtsoV2FeedConsumer {
    ...
    function getCurrentPrice() external view returns (uint256, int8, uint64)  {
        (uint256 feedValue, int8 decimals, uint64 timestamp) = ftsoV2
            .getFeedById(0x014554482f55534400000000000000000000000000);
...
//  get the final price as:  feedValue / (10  ** (decimals))